...
export const changeCurrentIndexAndSongAction = (tag) => {
  return (dispatch, getState) => {
    ...
    switch (sequence) {
      case 1: //随机播放
        let randonIndex = getRandomNumber(playList.length);
        while (randonIndex === currentSongIndex) {
          randonIndex = getRandomNumber(playList.length);
        }
        currentSongIndex = randonIndex;
        break;
      default: //顺序播放
